...
- 最近一次 UI 发布前验证备份：`/opt/quarkfantools/Platform-Deployment/backups/20260816T055728Z`。
...
| Platform Console | `2309841`（本轮表单/帮助交互发布候选；部署前生产仍为 `c338794`） |
| Platform Deployment | `10b0f62` |
