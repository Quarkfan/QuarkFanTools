...
Module-specific documents should live inside their owning submodule. For example, Message Gateway-specific design lives in `../Message-Gateway/docs/message-gateway.md`, Context Hub-specific design lives in `../Context-Hub/docs/context-hub.md` plus `../Context-Hub/docs/implementation-blueprint.md`, and Model Hub-specific design lives in `../Model-Hub/docs/model-hub.md` plus `../Model-Hub/docs/implementation-blueprint.md`.
